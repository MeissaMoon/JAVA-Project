...
<%
	...
	if (boardLists.size() == 0) {
		...
		for (int i = 0; i < boardLists.size(); i++) {
			...
			sbHTMLBoard.append("<tr>");
			sbHTMLBoard.append("<td><a href=\"javascript:bbsView('"+seq+"');\" style=\"cursor:point\" >["+pseq_kind+"] "+subject+"</a> </td>");
	...
	if(commentLists.size() == 0){
		...
		for (int i = 0; i < commentLists.size(); i++) {
			...
			sbHTMLComment.append("<tr>");
			sbHTMLComment.append("<td><a href=\"javascript:bbsView('"+seq+"');\" style=\"cursor:point\" >["+cpseq_kind+"] "+comment+"</a> </td>");
	...
	if( pqLists.size() == 0 ){
		...
		for(int i=0; i<pqLists.size();i++){
			...
			sbHTMLQnA.append("<td align=\"center\"><a href=\"javascript:bbsQView('"+seq+"');\" style=\"cursor:point\" >"+subject+"</a> </td>");
...
<script type="text/javascript">
	...
	function bbsView(seq) {
		window.open("admin_contents_view.mysql?cpage=1&seq=" + seq, "getBbs1", "width=800,height=850,resizable=yes,scrollbars=yes, left=50, top=50");				
	};
	...
	*/
	...
	function bbsQView(seq) {
		window.open("admin_qnaq.mysql?cpage=1&seq=" + seq, "getBbs1", "width=800,height=850,resizable=no,scrollbars=yes, left=50, top=50");				
	}
</script>
						...
						<tbody><tr>
							<td>
								...
								<button type="button" class="h18 t3 color small round red_s" onclick="delurl()">삭제</button>						
														...
														<tr>
							<td>
								링크명 : <input type="text" size="15" class="input" name="url[]" value="주문관리">
								Url : <input type="text" size="50" class="input" name="urlname[]" value="/adm/manage/product/order_list.php">
								사용여부 : 
								<input id="c1" checked="" type="checkbox" onclick="used('c1','t1');">	 
								<input id="t1" type="hidden" class="input" name="used[]" value="Y">
							</td>
						</tr>
														<tr>
							<td>
								링크명 : <input type="text" size="15" class="input" name="url[]" value="회원관리">
								Url : <input type="text" size="50" class="input" name="urlname[]" value="/adm/manage/member/member_list.php">
								사용여부 : 
								<input id="c2" checked="" type="checkbox" onclick="used('c2','t2');">	 
								<input id="t2" type="hidden" class="input" name="used[]" value="Y">
							</td>
						</tr>
														<tr>
							<td>
								링크명 : <input type="text" size="15" class="input" name="url[]" value="게시판관리">
								Url : <input type="text" size="50" class="input" name="urlname[]" value="/adm/manage/bbs/bbs_list.php">
								사용여부 : 
								<input id="c3" checked="" type="checkbox" onclick="used('c3','t3');">	 
								<input id="t3" type="hidden" class="input" name="used[]" value="Y">
							</td>
						</tr>
													</tbody></table>
				</td>
...
4936eb8			</li>
    ...
    <div class="Quicklink top15">
        ...
        <ul class="cont">
			<li><a href="./admin_contents.mysql?cpage=1&codeopt=1&sdate=&edate=&searchopt=&searchkey=">게시물 통합관리</a></li>
			<li><a href="./admin_comments.mysql?cpage=1&codeopt=1&sdate=&edate=&searchopt=&searchkey=">댓글 통합관리</a></li>
			<li><a href="./admin_user.mysql?cpage=1&sdate=&edate=&searchopt=&searchkey=">회원 통합관리</a></li>
			        </ul>
...
<div class="main_cont">
	...
	<div class="leftcont M_latest">
		...
		<a href="./admin_contents.mysql?cpage=1&codeopt=1&sdate=&edate=&searchopt=&searchkey=" onfocus="this.blur();" class="more"><img src="./resources/assets/img/admin/main/more.gif"></a>
	</div>
	<div class="rightcont M_latest">
		...
		<a href="./admin_comments.mysql?cpage=1&codeopt=1&sdate=&edate=&searchopt=&searchkey=" onfocus="this.blur();" class="more"><img src="./resources/assets/img/admin/main/more.gif"></a>
	</div>
	<!-- //M_latest// -->
	...
	<!-- <div class="rightcont M_visitor">
		...
		<div class="visitor_latest">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tbody>
					<tr>
						<td><a href="../schedule/list.php?code=schedule">[스케쥴] test</a> </td>
			...
			<tbody>
						<tr>
				<td class="lt"><a href="../product/order_info.php?orderid=180607183731894">180607183731894</a></td>
				<td>test</td>
				<td>무통장입금</td>
				<td>13,000</td>
				<td>결제완료</td>
						...
						<tr>
				<td class="lt"><a href="../product/order_info.php?orderid=180406095402222">180406095402222</a></td>
				<td>테스트</td>
				<td>무통장입금</td>
				<td>13,000</td>
				<td>배송완료</td>
						...
						<tr>
				<td class="lt"><a href="../product/order_info.php?orderid=180406095313736">180406095313736</a></td>
				<td>테스트</td>
				<td>무통장입금</td>
				<td>23,500</td>
				<td><b style="color:red">주문취소</b></td>
			</tr>
						<tr>
				<td class="lt"><a href="../product/order_info.php?orderid=171201174244737">171201174244737</a></td>
				<td>테스트</td>
				<td>무통장입금</td>
				<td>62,600</td>
				<td>주문접수</td>
		 ...
		 <div class="visitor_stats">
			<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
				<tbody>
					<tr>
						<th class="lt">오늘매출액</th>
						<td><span>0 </span> 원</td>
						<th>올해매출액</th>
						<td><span>0</span> 원</td>
					</tr>
					<tr>
						<th class="lt bt">이달매출액</th>
						<td class="bt"><span>0</span> 원</td>
						<th class="bt">총매출액</th>
						<td class="bt"><span>2,009,695</span> 원</td>
					</tr>
				</tbody>
			</table>
		</div>
		<a href="../product/order_list.php" onfocus="this.blur();" class="more"><img src="./resources/assets/img/admin/main/more.gif"></a>
	</div> -->

	<div class="leftcont M_latest_re">
		<p class="tit type2"><span>최근</span> 1:1 질문</p>
		<div class="cont">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tbody>
					<%=sbHTMLQnA %>								
		...
		<a href="./admin_qna.mysql?cpage=1&sdate=&edate=&searchopt=&searchkey=" onfocus="this.blur();" class="more"><img src="./resources/assets/img/admin/main/more.gif"></a>
	</div>
	<!-- //M_latest_re// -->

	<div class="rightcont M_member">
		<p class="tit type2"><span>회원</span>현황<a href="./admin_user.mysql?cpage=1&sdate=&edate=&searchopt=&searchkey=" style="float:right;padding-right:10px;padding-top:3px"><img src="./resources/assets/img/admin/main/more.gif"></a></p>
	...
	<div class="leftcont graph1">
		<div class="cont">
			<p class="tit type2"><span>게시판</span>통계<a href="./admin_user.mysql?cpage=1&sdate=&edate=&searchopt=&searchkey=" style="float:right;padding-right:10px;padding-top:3px"><img src="./resources/assets/img/admin/main/more.gif"></a></p>
			<br>
			<script type="text/javascript" src="/adm/js/json2.js"></script>
<script type="text/javascript" src="/adm/js/swfobject.js"></script>
<script type="text/javascript">
swfobject.embedSWF("/adm/flashChart/open-flash-chart.swf", "my_chart1", "100%", "250", "9.0.0", "/adm/flashChart/expressInstall.swf", {"data-file":"/adm/flashChart/chartData.php?chart_param=board","loading":"로딩중..."},{"wmode":"transparent"});
</script>
<div id="my_chart1"></div>
			<div style="padding-top:5px">
				<font style="padding-left:15px" color="#01a595">■</font><font style="color:#797979; font-size:11px;">게시글수</font>
				<font style="padding-left:15px" color="#FD6E06">■</font><font style="color:#797979; font-size:11px;">코멘트수</font>
			</div>
		</div>
	...
	<div class="rightcont graph2">
		<div class="cont">
			<p class="tit type2"><span>회원 수</span> 변동 추이<a href="/adm/manage/connect/connect_list.php" style="float:right;padding-right:10px;padding-top:3px"><img src="./resources/assets/img/admin/main/more.gif"></a></p>
			<br>
			<script type="text/javascript" src="/adm/js/json2.js"></script>
<script type="text/javascript" src="/adm/js/swfobject.js"></script>
<script type="text/javascript">
swfobject.embedSWF("/adm/flashChart/open-flash-chart.swf", "my_chart2", "100%", "250", "9.0.0", "/adm/flashChart/expressInstall.swf", {"data-file":"/adm/flashChart/chartData.php?chart_param=common|OD|2020-04-01|2020-04-30","loading":"로딩중..."},{"wmode":"transparent"});
</script>
<div id="my_chart2"></div>			<div style="padding-top:5px">
				<font style="padding-left:15px" color="#01a595">■</font><font style="color:#797979; font-size:11px;">방문자수</font>
			</div>
		</div>
		<!-- //graph2// -->
